            ...
            <div className='max-w-xl mx-auto my-10'>
                <form onSubmit={submitHandler} >
                    <div className='flex items-center gap-5 p-8'>
                        <Button onClick = {()=> navigate("/admin/companies")} variant='' className='flex items-center justify-between gap-2  bg-green-500 hover:bg-green-600'>
                            <ArrowLeft />
                            <span>Back</span>
                        </Button>
                        <h1 className='font-bold text-xl text-green-500 uppercase '>Company Setup</h1>
